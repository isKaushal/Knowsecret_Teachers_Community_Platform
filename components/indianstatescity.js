...
const STATES_OBJECT = [
  ...
  { id: 3, label: "Assam", value: "Assam", name: "Assam" },
  { id: 4, label: "Bihar", value: "Bihar", name: "Bihar" },
  { id: 5, label: "Chandigarh", value: "Chandigarh", name: "Chandigarh" },
  { id: 6, label: "Chhattisgarh", value: "Chhattisgarh", name: "Chhattisgarh" },
  {
    id: 7,
  ...
  { id: 9, label: "Delhi", value: "Delhi", name: "Delhi" },
  { id: 10, label: "Goa", value: "Goa", name: "Goa" },
  { id: 11, label: "Gujarat", value: "Gujarat", name: "Gujarat" },
  { id: 12, label: "Haryana", value: "Haryana", name: "Haryana" },
  {
    id: 13,
  ...
  { id: 15, label: "Jharkhand", value: "Jharkhand", name: "Jharkhand" },
  { id: 16, label: "Karnataka", value: "Karnataka", name: "Karnataka" },
  { id: 17, label: "Kerala", value: "Kerala", name: "Kerala" },
  { id: 18, label: "Ladakh", value: "Ladakh", name: "Ladakh" },
  { id: 19, label: "Lakshadweep", value: "Lakshadweep", name: "Lakshadweep" },
  {
    id: 20,
  ...
  { id: 21, label: "Maharashtra", value: "Maharashtra", name: "Maharashtra" },
  { id: 22, label: "Manipur", value: "Manipur", name: "Manipur" },
  { id: 23, label: "Meghalaya", value: "Meghalaya", name: "Meghalaya" },
  { id: 24, label: "Mizoram", value: "Mizoram", name: "Mizoram" },
  { id: 25, label: "Nagaland", value: "Nagaland", name: "Nagaland" },
  { id: 26, label: "Odisha", value: "Odisha", name: "Odisha" },
  { id: 27, label: "Puducherry", value: "Puducherry", name: "Puducherry" },
  { id: 28, label: "Punjab", value: "Punjab", name: "Punjab" },
  { id: 29, label: "Rajasthan", value: "Rajasthan", name: "Rajasthan" },
  { id: 30, label: "Sikkim", value: "Sikkim", name: "Sikkim" },
  { id: 31, label: "Tamil Nadu", value: "Tamil Nadu", name: "TamilNadu" },
  { id: 32, label: "Telangana", value: "Telangana", name: "Telangana" },
  { id: 33, label: "Tripura", value: "Tripura", name: "Tripura" },
  { id: 34, label: "Uttarakhand", value: "Uttarakhand", name: "Uttarakhand" },
  {
    id: 35,
    label: "Uttar Pradesh",
    value: "Uttar Pradesh",
  ...
  { id: 36, label: "West Bengal", value: "West Bengal", name: "WestBengal" },
];
